...
import flower from "../../assets/images/t1.png";
import flower1 from "../../assets/images/t2.png";
...
const OneTime = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="bg-[#ffe599] p-5 rounded-md relative z-[1]">
          ...
          <img src={flower1} alt="" className="absolute top-0 left-56 " />
          <img src={flower} alt="" className="absolute bottom-0 left-96 " />
        </div>
      </div>
