...
import flower from "../../assets/images/v1.png";
import flower1 from "../../assets/images/v2.png";
...
const Recurring = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="bg-[#9df2c1] p-5 rounded-md relative z-[1]">
          ...
          <img src={flower} alt="" className="absolute top-0 left-40 " />
