import { ConfigProvider, Form, Input, Modal, Steps } from "antd";
  ...
  return (
    <div>
      <div className=" my-5">
        ...
        <div className="my-5 flex justify-between items-center mt-10">
          <h1 className="text-3xl font-bold ">Envlopes</h1>
          <button
            onClick={handleModalOpen}
            className="bg-btnPrimary text-white  py-2 px-4 rounded-xl flex justify-center items-center  gap-2"
          >
            <FaPlus /> Add Envelop
          </button>
        </div>
        <div className="my-5 grid grid-cols-1 md:grid-cols-4 justify-between items-center gap-4">
          <div className="h-40 border bg-neutral-200 py-4 px-6 rounded-xl text-center ">
            ...
            <p className="text-sm  text-neutral-800">
              ...
              fugit vero iste maiores, ex corporis dolore, blanditiis vitae sunt
              commodi hic praesentium omnis deserunt. Aut adipisci fuga ex alias
              nesciunt.
            </p>
          </div>
          <div className="h-40 border bg-neutral-200 py-4 px-6 rounded-xl text-center ">
