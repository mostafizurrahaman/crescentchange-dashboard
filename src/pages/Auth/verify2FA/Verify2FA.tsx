...
import { useVerifyCodeAndEnavble2FAMutation } from "../../../redux/features/twoFA/twoFA";
...
const Verify2FA = () => {
  ...
  const handleVerifyCodeAndEnable2FA = async (token: string) => {
    try {
      ...
      navigate("/"); // You can replace this with your desired redirect route
    } catch (error) {
      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8">
        ...
        {!qrCodeUrl ? (
          <div className="text-center">
            <p className="mb-4 text-gray-600">Please verify your account by scanning the QR code with your authenticator app.</p>
            <input
              type="text"
